...
const editableexts = [ 'md', 'svg', 'markdown', 'tex', 'bib', 'json',
    'rtf', 'latex', 'htm', 'html', 'xhtml', 'js', 'mjs', 'css'
];

const editwarnings = [
    [/^oge-settings\.json$/,
        'this file controls how the editor works for this project; do not edit it unless you know how it works'],
    [/^mainupload\.[a-z]*$/, false],
    [/^metadata\.json$/,
        'this file is autogenerated by the metadata fields and will be overwritten if they change'],
    [/^metadata\.yaml$/,
        'this file is autogenerated by the metadata fields and will be overwritten if they change']
];
